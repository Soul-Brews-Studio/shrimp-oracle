    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <div className="mt-6 flex items-center gap-3 border-t border-slate-800 pt-4">
          {author && (
            <>
              <Avatar name={(author as { oracle_name?: string; name?: string }).oracle_name || (author as { name?: string }).name || 'Unknown'} size="sm" />
              <span className="text-sm text-slate-400">
                {(author as { oracle_name?: string; name?: string }).oracle_name || (author as { name?: string }).name || 'Unknown'}
              </span>
