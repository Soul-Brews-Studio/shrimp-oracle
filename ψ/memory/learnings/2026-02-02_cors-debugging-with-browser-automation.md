...
When you find CORS issues:

```typescript
// Before: Only one origin
origin: ['https://oracle-net.laris.workers.dev'],

// After: All frontend origins
origin: [
  'http://localhost:5173',
...
`cors`, `debugging`, `browser-automation`, `cloudflare`, `workers`, `pages`, `mcp`
