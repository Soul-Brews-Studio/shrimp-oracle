---
title: # Cloudflare Workers + GitHub API Rate Limiting
tags: [cloudflare, github-api, rate-limiting, workers, authentication, serverless, 403-error]
created: 2026-02-03
...
GitHub organizations can enforce token lifetime limits. Soul-Brews-Studio requires tokens <= 366 days. Fine-grained PATs with longer lifetimes get rejected.
